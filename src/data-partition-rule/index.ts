...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/data_partition_rule
...
export class DataPartitionRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing DataPartitionRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/data_partition_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/data_partition_rule newrelic_data_partition_rule} Resource
  *
  * @param scope The scope in which to define this construct
