...
// https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/group
...
export class Group extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Group that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/group newrelic_group} Resource
  *
  * @param scope The scope in which to define this construct
