...
// https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/data-sources/fleet_configuration
...
export class DataNewrelicFleetConfiguration extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicFleetConfiguration that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/data-sources/fleet_configuration#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/data-sources/fleet_configuration newrelic_fleet_configuration} Data Source
  *
  * @param scope The scope in which to define this construct
