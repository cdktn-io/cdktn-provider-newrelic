...
// https://registry.terraform.io/providers/newrelic/newrelic/3.81.0/docs/resources/log_parsing_rule
...
export class LogParsingRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing LogParsingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.81.0/docs/resources/log_parsing_rule#import import section} in the documentation of this resource for the id to use
