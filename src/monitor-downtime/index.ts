...
// https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime
...
export interface MonitorDowntimeConfig extends cdktn.TerraformMetaArguments {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#account_id MonitorDowntime#account_id}
  */
  readonly accountId?: number;
  /**
  * A datetime stamp signifying the end of the Monitor Downtime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#end_time MonitorDowntime#end_time}
  */
  readonly endTime: string;
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#id MonitorDowntime#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#maintenance_days MonitorDowntime#maintenance_days}
  */
  readonly maintenanceDays?: string[];
  /**
  * An identifier of the type of Monitor Downtime to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#mode MonitorDowntime#mode}
  */
  readonly mode: string;
  /**
  * A list of GUIDs of monitors, to which the created Monitor Downtime shall be applied.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#monitor_guids MonitorDowntime#monitor_guids}
  */
  readonly monitorGuids?: string[];
  /**
  * A name to identify the Monitor Downtime to be created.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#name MonitorDowntime#name}
  */
  readonly name: string;
  /**
  * A datetime stamp signifying the start of the Monitor Downtime.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#start_time MonitorDowntime#start_time}
  */
  readonly startTime: string;
  /**
  * The timezone that applies to the Monitor Downtime schedule.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#time_zone MonitorDowntime#time_zone}
  */
  readonly timeZone: string;
  /**
  * end_repeat block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#end_repeat MonitorDowntime#end_repeat}
  */
  readonly endRepeat?: MonitorDowntimeEndRepeat;
  /**
  * frequency block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#frequency MonitorDowntime#frequency}
  */
...
export interface MonitorDowntimeEndRepeat {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#on_date MonitorDowntime#on_date}
  */
  readonly onDate?: string;
  /**
  * Number of repetitions after which the Monitor Downtime's repeat cycle is expected to end.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#on_repeat MonitorDowntime#on_repeat}
  */
...
export interface MonitorDowntimeFrequencyDaysOfWeek {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#ordinal_day_of_month MonitorDowntime#ordinal_day_of_month}
  */
  readonly ordinalDayOfMonth: string;
  /**
  * The day of the week on which the Monitor Downtime would run.
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#week_day MonitorDowntime#week_day}
  */
...
export interface MonitorDowntimeFrequency {
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#days_of_month MonitorDowntime#days_of_month}
  */
  readonly daysOfMonth?: number[];
  /**
  * days_of_week block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#days_of_week MonitorDowntime#days_of_week}
  */
...
/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime newrelic_monitor_downtime}
*/
export class MonitorDowntime extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MonitorDowntime that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/resources/monitor_downtime newrelic_monitor_downtime} Resource
  *
  * @param scope The scope in which to define this construct
