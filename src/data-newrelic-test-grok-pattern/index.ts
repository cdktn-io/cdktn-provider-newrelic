...
// https://registry.terraform.io/providers/newrelic/newrelic/3.95.0/docs/data-sources/test_grok_pattern
...
export class DataNewrelicTestGrokPattern extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicTestGrokPattern that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.95.0/docs/data-sources/test_grok_pattern#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.95.0/docs/data-sources/test_grok_pattern newrelic_test_grok_pattern} Data Source
  *
  * @param scope The scope in which to define this construct
