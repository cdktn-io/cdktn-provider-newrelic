...
// https://registry.terraform.io/providers/newrelic/newrelic/3.96.1/docs/data-sources/api_access_key
...
export class DataNewrelicApiAccessKey extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicApiAccessKey that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.96.1/docs/data-sources/api_access_key#import import section} in the documentation of this resource for the id to use
