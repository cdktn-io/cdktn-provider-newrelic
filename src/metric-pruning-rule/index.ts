...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.3/docs/resources/metric_pruning_rule
...
export class MetricPruningRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing MetricPruningRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.3/docs/resources/metric_pruning_rule#import import section} in the documentation of this resource for the id to use
