...
// https://registry.terraform.io/providers/newrelic/newrelic/3.95.1/docs/resources/alert_channel
...
export class AlertChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.95.1/docs/resources/alert_channel#import import section} in the documentation of this resource for the id to use
