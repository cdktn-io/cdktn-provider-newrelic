...
// https://registry.terraform.io/providers/newrelic/newrelic/3.96.2/docs/resources/federated_logs_setup
...
export class FederatedLogsSetup extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FederatedLogsSetup that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.96.2/docs/resources/federated_logs_setup#import import section} in the documentation of this resource for the id to use
