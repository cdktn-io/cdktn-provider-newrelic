...
// https://registry.terraform.io/providers/newrelic/newrelic/3.84.0/docs
...
export class NewrelicProvider extends cdktn.TerraformProvider {
  ...
  * @param importFromId The id of the existing NewrelicProvider that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.84.0/docs#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.84.0/docs newrelic} Resource
  *
  * @param scope The scope in which to define this construct
