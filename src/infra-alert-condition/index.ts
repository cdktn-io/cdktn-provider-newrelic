...
// https://registry.terraform.io/providers/newrelic/newrelic/3.86.0/docs/resources/infra_alert_condition
...
export class InfraAlertCondition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing InfraAlertCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.86.0/docs/resources/infra_alert_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.86.0/docs/resources/infra_alert_condition newrelic_infra_alert_condition} Resource
  *
  * @param scope The scope in which to define this construct
