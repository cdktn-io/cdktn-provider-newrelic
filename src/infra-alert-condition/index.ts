...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/infra_alert_condition
...
export class InfraAlertCondition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing InfraAlertCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/infra_alert_condition#import import section} in the documentation of this resource for the id to use
