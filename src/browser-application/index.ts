...
// https://registry.terraform.io/providers/newrelic/newrelic/3.84.0/docs/resources/browser_application
...
export class BrowserApplication extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing BrowserApplication that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.84.0/docs/resources/browser_application#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.84.0/docs/resources/browser_application newrelic_browser_application} Resource
  *
  * @param scope The scope in which to define this construct
