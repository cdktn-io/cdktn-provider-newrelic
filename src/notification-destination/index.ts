...
// https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/notification_destination
...
export function notificationDestinationScopeToTerraform(struct?: NotificationDestinationScopeOutputReference | NotificationDestinationScope): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export function notificationDestinationScopeToHclTerraform(struct?: NotificationDestinationScopeOutputReference | NotificationDestinationScope): any {
  if (!cdktn.canInspect(struct) || cdktn.Tokenization.isResolvable(struct)) { return struct; }
  if (cdktn.isComplexElement(struct)) {
    throw new Error("A complex element was used as configuration, this is not supported: https://cdk.tf/complex-object-as-configuration");
  }
...
export class NotificationDestinationScopeOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
  ...
  */
  ...
  public get internalValue(): NotificationDestinationScope | undefined {
    let hasAnyValues = this.isEmptyObject;
    const internalValueResult: any = {};
  ...
  public set internalValue(value: NotificationDestinationScope | undefined) {
    if (value === undefined) {
      this.isEmptyObject = false;
      this._id = undefined;
...
export class NotificationDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/notification_destination#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/notification_destination newrelic_notification_destination} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  private _scope = new NotificationDestinationScopeOutputReference(this, "scope");
  public get scope() {
    return this._scope;
  }
  public putScope(value: NotificationDestinationScope) {
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      scope: notificationDestinationScopeToTerraform(this._scope.internalValue),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      scope: {
        value: notificationDestinationScopeToHclTerraform(this._scope.internalValue),
        isBlock: true,
        type: "list",
        storageClassType: "NotificationDestinationScopeList",
      },
      secure_url: {
