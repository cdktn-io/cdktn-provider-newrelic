...
// https://registry.terraform.io/providers/newrelic/newrelic/3.94.0/docs/resources/notification_destination
...
export class NotificationDestination extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationDestination that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.94.0/docs/resources/notification_destination#import import section} in the documentation of this resource for the id to use
