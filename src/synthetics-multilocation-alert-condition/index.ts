...
// https://registry.terraform.io/providers/newrelic/newrelic/3.86.0/docs/resources/synthetics_multilocation_alert_condition
...
export interface SyntheticsMultilocationAlertConditionConfig extends cdktn.TerraformMetaArguments {
  /**
...
export class SyntheticsMultilocationAlertConditionCriticalOutputReference extends cdktn.ComplexObject {
...
export class SyntheticsMultilocationAlertConditionWarningOutputReference extends cdktn.ComplexObject {
  private isEmptyObject = false;
...
*/
export class SyntheticsMultilocationAlertCondition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticsMultilocationAlertCondition that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.86.0/docs/resources/synthetics_multilocation_alert_condition#import import section} in the documentation of this resource for the id to use
  ...
  */
  public static generateConfigForImport(scope: Construct, importToId: string, importFromId: string, provider?: cdktn.TerraformProvider) {
        return new cdktn.ImportableResource(scope, importToId, { terraformResourceType: "newrelic_synthetics_multilocation_alert_condition", importId: importFromId, provider });
      }
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.86.0/docs/resources/synthetics_multilocation_alert_condition newrelic_synthetics_multilocation_alert_condition} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      entities: cdktn.listMapper(cdktn.stringToTerraform, false)(this._entities),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      entities: {
        value: cdktn.listMapperHcl(cdktn.stringToHclTerraform, false)(this._entities),
        isBlock: false,
        type: "list",
