...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.3/docs/resources/alert_policy
...
export class AlertPolicy extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.3/docs/resources/alert_policy#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.3/docs/resources/alert_policy newrelic_alert_policy} Resource
  *
  * @param scope The scope in which to define this construct
