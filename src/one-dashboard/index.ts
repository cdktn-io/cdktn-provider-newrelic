...
export interface OneDashboardConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.2/docs/resources/one_dashboard#id OneDashboard#id}
  *
  ...
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.2/docs/resources/one_dashboard#permissions OneDashboard#permissions}
  */
  readonly permissions?: string;
  /**
  * page block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.2/docs/resources/one_dashboard#page OneDashboard#page}
  */
  readonly page: OneDashboardPage[] | cdktn.IResolvable;
  /**
  * variable block
  *
  * Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.2/docs/resources/one_dashboard#variable OneDashboard#variable}
  */
  readonly variable?: OneDashboardVariable[] | cdktn.IResolvable;
}

/**
* Represents a {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.2/docs/resources/one_dashboard newrelic_one_dashboard}
*/
export class OneDashboard extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OneDashboard that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.2/docs/resources/one_dashboard#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.2/docs/resources/one_dashboard newrelic_one_dashboard} Resource
  *
  * @param scope The scope in which to define this construct
