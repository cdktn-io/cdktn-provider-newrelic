...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/notification_channel
...
export class NotificationChannel extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing NotificationChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/notification_channel#import import section} in the documentation of this resource for the id to use
