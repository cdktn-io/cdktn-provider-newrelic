...
// https://registry.terraform.io/providers/newrelic/newrelic/3.87.3/docs/data-sources/service_level_alert_helper
...
export class DataNewrelicServiceLevelAlertHelper extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicServiceLevelAlertHelper that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.3/docs/data-sources/service_level_alert_helper#import import section} in the documentation of this resource for the id to use
