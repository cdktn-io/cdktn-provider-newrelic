...
// https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/data-sources/service_level_alert_helper
...
export class DataNewrelicServiceLevelAlertHelper extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicServiceLevelAlertHelper that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/data-sources/service_level_alert_helper#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/data-sources/service_level_alert_helper newrelic_service_level_alert_helper} Data Source
  *
  * @param scope The scope in which to define this construct
