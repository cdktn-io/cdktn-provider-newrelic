...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.3/docs/resources/synthetics_script_monitor
...
export class SyntheticsScriptMonitor extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticsScriptMonitor that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.3/docs/resources/synthetics_script_monitor#import import section} in the documentation of this resource for the id to use
