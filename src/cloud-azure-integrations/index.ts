...
// https://registry.terraform.io/providers/newrelic/newrelic/3.96.4/docs/resources/cloud_azure_integrations
...
export class CloudAzureIntegrations extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudAzureIntegrations that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.96.4/docs/resources/cloud_azure_integrations#import import section} in the documentation of this resource for the id to use
