...
// https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/data-sources/authentication_domain
...
export class DataNewrelicAuthenticationDomain extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicAuthenticationDomain that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.1/docs/data-sources/authentication_domain#import import section} in the documentation of this resource for the id to use
