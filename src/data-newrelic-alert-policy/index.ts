...
// https://registry.terraform.io/providers/newrelic/newrelic/3.96.1/docs/data-sources/alert_policy
...
export class DataNewrelicAlertPolicy extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicAlertPolicy that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.96.1/docs/data-sources/alert_policy#import import section} in the documentation of this resource for the id to use
