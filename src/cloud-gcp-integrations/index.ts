...
// https://registry.terraform.io/providers/newrelic/newrelic/3.80.3/docs/resources/cloud_gcp_integrations
...
export class CloudGcpIntegrations extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudGcpIntegrations that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.80.3/docs/resources/cloud_gcp_integrations#import import section} in the documentation of this resource for the id to use
