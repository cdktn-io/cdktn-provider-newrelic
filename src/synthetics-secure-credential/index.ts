...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.5/docs/resources/synthetics_secure_credential
...
export class SyntheticsSecureCredential extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing SyntheticsSecureCredential that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.5/docs/resources/synthetics_secure_credential#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.5/docs/resources/synthetics_secure_credential newrelic_synthetics_secure_credential} Resource
  *
  * @param scope The scope in which to define this construct
