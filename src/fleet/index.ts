...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.6/docs/resources/fleet
...
export class Fleet extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Fleet that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.6/docs/resources/fleet#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.6/docs/resources/fleet newrelic_fleet} Resource
  *
  * @param scope The scope in which to define this construct
