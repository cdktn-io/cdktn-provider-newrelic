...
// https://registry.terraform.io/providers/newrelic/newrelic/3.90.0/docs/resources/fleet_deployment
...
export class FleetDeployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FleetDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.90.0/docs/resources/fleet_deployment#import import section} in the documentation of this resource for the id to use
