...
// https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/fleet_deployment
...
export class FleetDeploymentAgentOutputReference extends cdktn.ComplexObject {
  ...
  */
  ...
  // configuration_version_id - computed: false, optional: true, required: false
  ...
  public resetConfigurationVersionId() {
    this._configurationVersionId = undefined;
  }
  // Temporarily expose input value. Use with caution.
...
export class FleetDeployment extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FleetDeployment that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/fleet_deployment#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/fleet_deployment newrelic_fleet_deployment} Resource
  *
  * @param scope The scope in which to define this construct
