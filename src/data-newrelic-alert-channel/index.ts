...
// https://registry.terraform.io/providers/newrelic/newrelic/3.84.0/docs/data-sources/alert_channel
...
export class DataNewrelicAlertChannel extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicAlertChannel that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.84.0/docs/data-sources/alert_channel#import import section} in the documentation of this resource for the id to use
