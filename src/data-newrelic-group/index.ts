...
// https://registry.terraform.io/providers/newrelic/newrelic/3.85.1/docs/data-sources/group
...
*/
export class DataNewrelicGroup extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicGroup that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.85.1/docs/data-sources/group#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.85.1/docs/data-sources/group newrelic_group} Data Source
  *
  * @param scope The scope in which to define this construct
