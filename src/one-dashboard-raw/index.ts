...
// https://registry.terraform.io/providers/newrelic/newrelic/3.95.1/docs/resources/one_dashboard_raw
...
export class OneDashboardRaw extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing OneDashboardRaw that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.95.1/docs/resources/one_dashboard_raw#import import section} in the documentation of this resource for the id to use
