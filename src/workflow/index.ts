...
// https://registry.terraform.io/providers/newrelic/newrelic/3.93.0/docs/resources/workflow
...
export class Workflow extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Workflow that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.93.0/docs/resources/workflow#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.93.0/docs/resources/workflow newrelic_workflow} Resource
  *
  * @param scope The scope in which to define this construct
