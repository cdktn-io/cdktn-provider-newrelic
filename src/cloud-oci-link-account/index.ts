...
// https://registry.terraform.io/providers/newrelic/newrelic/3.94.0/docs/resources/cloud_oci_link_account
...
export class CloudOciLinkAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudOciLinkAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.94.0/docs/resources/cloud_oci_link_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.94.0/docs/resources/cloud_oci_link_account newrelic_cloud_oci_link_account} Resource
  *
  * @param scope The scope in which to define this construct
