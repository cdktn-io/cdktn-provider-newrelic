...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.5/docs/resources/cloud_oci_link_account
...
export interface CloudOciLinkAccountConfig extends cdktn.TerraformMetaArguments {
  ...
  */
  ...
  /**
  * Optional value propagated as the ext_resource_tag claim on the RPST for tag-based scoping in customer IAM policies. Ignored for UPST. Cannot be changed after creation.
  *
  ...
  */
  ...
  /**
  * OCI WIF trust type. Allowed: UPST (default), RPST. RPST uses claim-based ephemeral principals; UPST impersonates a service user. Cannot be changed after creation — re-create the linked account to switch trust types.
  *
...
export class CloudOciLinkAccount extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CloudOciLinkAccount that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.5/docs/resources/cloud_oci_link_account#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.5/docs/resources/cloud_oci_link_account newrelic_cloud_oci_link_account} Resource
  *
  * @param scope The scope in which to define this construct
  ...
  */
  ...
  // trust_type - computed: false, optional: true, required: false
  ...
  protected synthesizeAttributes(): { [name: string]: any } {
    return {
      ...
      resource_tag: cdktn.stringToTerraform(this._resourceTag),
  ...
  protected synthesizeHclAttributes(): { [name: string]: any } {
    const attrs = {
      ...
      resource_tag: {
        value: cdktn.stringToHclTerraform(this._resourceTag),
        isBlock: false,
        type: "simple",
        storageClassType: "string",
      },
