...
// https://registry.terraform.io/providers/newrelic/newrelic/3.93.0/docs/resources/insights_event
...
export class InsightsEvent extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing InsightsEvent that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.93.0/docs/resources/insights_event#import import section} in the documentation of this resource for the id to use
