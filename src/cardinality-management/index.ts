...
// https://registry.terraform.io/providers/newrelic/newrelic/3.98.0/docs/resources/cardinality_management
...
export class CardinalityManagement extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing CardinalityManagement that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.98.0/docs/resources/cardinality_management#import import section} in the documentation of this resource for the id to use
