...
// https://registry.terraform.io/providers/newrelic/newrelic/3.93.1/docs/resources/aws_connection
...
export class AwsConnection extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AwsConnection that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.93.1/docs/resources/aws_connection#import import section} in the documentation of this resource for the id to use
