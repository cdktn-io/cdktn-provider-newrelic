...
// https://registry.terraform.io/providers/newrelic/newrelic/3.96.2/docs/resources/federated_logs_partition
...
export class FederatedLogsPartition extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FederatedLogsPartition that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.96.2/docs/resources/federated_logs_partition#import import section} in the documentation of this resource for the id to use
