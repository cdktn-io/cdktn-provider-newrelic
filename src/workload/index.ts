...
// https://registry.terraform.io/providers/newrelic/newrelic/3.85.0/docs/resources/workload
...
export class Workload extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing Workload that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.85.0/docs/resources/workload#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.85.0/docs/resources/workload newrelic_workload} Resource
  *
  * @param scope The scope in which to define this construct
