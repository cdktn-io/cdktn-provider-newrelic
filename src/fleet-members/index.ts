...
// https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/fleet_members
...
export class FleetMembers extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing FleetMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/fleet_members#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/fleet_members newrelic_fleet_members} Resource
  *
  * @param scope The scope in which to define this construct
