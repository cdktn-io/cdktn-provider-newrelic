...
// https://registry.terraform.io/providers/newrelic/newrelic/3.85.0/docs/resources/alert_muting_rule
...
export class AlertMutingRule extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing AlertMutingRule that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.85.0/docs/resources/alert_muting_rule#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.85.0/docs/resources/alert_muting_rule newrelic_alert_muting_rule} Resource
  *
  * @param scope The scope in which to define this construct
