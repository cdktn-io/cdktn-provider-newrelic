...
// https://registry.terraform.io/providers/newrelic/newrelic/3.91.0/docs/data-sources/user
...
export class DataNewrelicUser extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicUser that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.91.0/docs/data-sources/user#import import section} in the documentation of this resource for the id to use
  ...
  */
  ...
  /**
  * Create a new {@link https://registry.terraform.io/providers/newrelic/newrelic/3.91.0/docs/data-sources/user newrelic_user} Data Source
  *
  * @param scope The scope in which to define this construct
