...
// https://registry.terraform.io/providers/newrelic/newrelic/3.95.2/docs/data-sources/fleet_members
...
export class DataNewrelicFleetMembers extends cdktn.TerraformDataSource {
  ...
  * @param importFromId The id of the existing DataNewrelicFleetMembers that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.95.2/docs/data-sources/fleet_members#import import section} in the documentation of this resource for the id to use
