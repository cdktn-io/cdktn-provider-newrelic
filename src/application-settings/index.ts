...
// https://registry.terraform.io/providers/newrelic/newrelic/3.94.2/docs/resources/application_settings
...
export class ApplicationSettings extends cdktn.TerraformResource {
  ...
  * @param importFromId The id of the existing ApplicationSettings that should be imported. Refer to the {@link https://registry.terraform.io/providers/newrelic/newrelic/3.94.2/docs/resources/application_settings#import import section} in the documentation of this resource for the id to use
