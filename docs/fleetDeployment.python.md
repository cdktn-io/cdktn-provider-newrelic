...
| <code><a href="#@cdktn/provider-newrelic.fleetDeployment.FleetDeployment.Initializer.parameter.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/fleet_deployment#id FleetDeployment#id}. |
...
##### `agent`<sup>Required</sup> <a name="agent" id="@cdktn/provider-newrelic.fleetDeployment.FleetDeployment.Initializer.parameter.agent"></a>
...
##### `configuration_version_id`<sup>Optional</sup> <a name="configuration_version_id" id="@cdktn/provider-newrelic.fleetDeployment.FleetDeploymentAgent.property.configurationVersionId"></a>
...
| <code><a href="#@cdktn/provider-newrelic.fleetDeployment.FleetDeploymentConfig.property.id">id</a></code> | <code>str</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.87.0/docs/resources/fleet_deployment#id FleetDeployment#id}. |
...
| <code><a href="#@cdktn/provider-newrelic.fleetDeployment.FleetDeploymentAgentOutputReference.resetConfigurationVersionId">reset_configuration_version_id</a></code> | *No description.* |
...
##### `reset_configuration_version_id` <a name="reset_configuration_version_id" id="@cdktn/provider-newrelic.fleetDeployment.FleetDeploymentAgentOutputReference.resetConfigurationVersionId"></a>

```python
def reset_configuration_version_id() -> None
```
