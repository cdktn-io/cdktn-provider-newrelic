...
```go
import "github.com/cdktn-io/cdktn-provider-newrelic-go/newrelic/v16/metricpruningrule"
...
| <code><a href="#@cdktn/provider-newrelic.metricPruningRule.MetricPruningRuleConfig.property.id">Id</a></code> | <code>*string</code> | Docs at Terraform Registry: {@link https://registry.terraform.io/providers/newrelic/newrelic/3.97.0/docs/resources/metric_pruning_rule#id MetricPruningRule#id}. |
